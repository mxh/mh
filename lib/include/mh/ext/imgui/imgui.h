...
namespace ImGui
{
    ...
    IMGUI_API void          PlotHistogram(const char* label, const float* values, int values_count, int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0,0), int stride = sizeof(float), void (*hover_callback)(int, float, void*) = NULL, void * hover_callback_this = NULL);
    IMGUI_API void          PlotHistogram(const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0,0), void (*hover_callback)(int, float, void*) = NULL, void * hover_callback_this = NULL);
...
enum ImGuiKey_
{
    ...
    ImGuiKey_Plus,      // for increasing global var
    ImGuiKey_Minus,     // for decreasing global var
    ImGuiKey_W,         // for navigation
    ImGuiKey_A,         // for text edit CTRL+A: select all and navigation
    ImGuiKey_S,         // for navigation
    ImGuiKey_D,         // for navigation
    ImGuiKey_R,         // for navigation
    ImGuiKey_F,         // for navigation
...
#include "mh/ext/imgui/imgui_user.h"
#endif
