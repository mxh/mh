...
namespace ImGui
{
    ...
    IMGUI_API void          PlotEx(ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 graph_size, void (*hover_callback)(int, float, void*) = NULL, void * hover_callback_this = NULL);
